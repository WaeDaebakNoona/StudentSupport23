 ...
 * @author Narita
 */
public class ViewMessagesUI extends javax.swing.JFrame {

    /**
     * Creates new form ViewMessagesUI
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewMessagesUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
